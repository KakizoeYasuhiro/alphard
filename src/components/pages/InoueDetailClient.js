      ...
      <div className="profile-section">
        ...
        <div className="profile-text ja-text">
          <div className="profile-section-content">
            ...
            <p>ミュージシャンとしては、ロックバンド・torch、ユニット・CASPER CAVEのキーボーディストとして活動後、現在は園木 邦宝バンドに正規メンバーとして参加しつつ、ソロアーティストとしての活動も開始。</p>
          ...
          <p>・園木邦宝(キーボーディスト・編曲者・エンジニア:2025-)</p>
