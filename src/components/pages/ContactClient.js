    ...
    if (name === 'contactType') {
      ...
      switch (value) {
        case 'ライブについて':
          message = (
            <>
              ・各ライブチケットの購入・予約方法につきましては、まずLIVEページをご確認いただき、そちらに記載のない場合や、TIGET・プレイガイドでの取り扱いがない場合、公式SNSのDMまたは当フォームにてお問い合わせください。<br />
        ...
        case '出演・取材依頼について':
          message = (
            <>
              ・ご依頼につきましては、当問い合わせフォームよりご連絡ください。その際、可能な範囲で企画内容、媒体名、ご希望日時、ご予算等の詳細をご記載いただけますと幸いです。<br />
        ...
        case '楽曲使用について':
          message = (
            <>
              ・当アーティストの楽曲のご利用に関するお問い合わせは、当フォームにて直接受け付けております。<br />
              ...
              ・個人の方が非営利目的で、当アーティストの楽曲をカバー演奏・歌唱・ダンスなどで使用し、SNS等にその動画や音声を投稿される場合は、出典（アーティスト名・曲名）を必ず明記してください。可能であれば、事前に当フォームよりご一報いただけますと幸いです。<br />
      ...
      <form className="contact-form" onSubmit={handleSubmit}>
        <div className="form-group">
          ...
          >
            ...
            <option value="ライブについて">ライブについて</option>
            <option value="グッズについて">グッズについて</option>
            <option value="アーティスト本人について">アーティスト本人について</option>
